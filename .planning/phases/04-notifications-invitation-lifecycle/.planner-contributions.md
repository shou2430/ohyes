# Phase 4 — Planner Capability Contributions (plan:pre)

> Injected verbatim from the GSD capability registry. Follow every block below.
...
**Resolved config values:** `{"security_asvs_level":1,"security_block_on":"high"}`
